...
public class MutableJavaColor extends Color {
    ...
    public MutableJavaColor(int r, int g, int b) {

        this(r, g, b, 255);
    }

    public MutableJavaColor(int r, int g, int b, int a) {
        super(r, g, b, a);
        value = ((a & 0xFF) << 24) |
                ((r & 0xFF) << 16) |
                ((g & 0xFF) << 8) |
     ...
     * @see #getRGB
     */
    public MutableJavaColor(int rgb) {
        super(rgb);
     ...
     * @see #getRGB
     */
    public MutableJavaColor(int rgba, boolean hasalpha) {
        super(rgba, hasalpha);
        if (hasalpha) {
            value = rgba;
        } else {
     ...
     * @see #getRGB
     */
    public MutableJavaColor(float r, float g, float b) {
     ...
     * @see #getRGB
     */
    public MutableJavaColor(float r, float g, float b, float a) {
     ...
     */
    public MutableJavaColor(ColorSpace cspace, float components[], float alpha) {
